...
\begin{itemize}
	...
	\begin{itemize}
		\item \structure{Termo}; e
		\item \structure{Predicado};
	\end{itemize}
...
\begin{exampleblock}{Exemplo:}
Sócrates é mortal\\
\structure{Termo}: Sócrates\\
\structure{Predicado}: é mortal
\end{exampleblock}
\end{frame}
...
\begin{itemize}
	...
	\item Para isso, é necessário transformar os argumentos com quantificadores em argumentos não quantificados, por meio de \structure{exemplificações};
	\item Em seguida, aplicar as regras de inferências lógicas já estudadas; e
	\item Por fim, uma vez concluída a prova de validade do argumento, usa-se a \structure{generalização} para obter a conclusão do argumento quantificado.
\end{itemize}
\end{frame}
